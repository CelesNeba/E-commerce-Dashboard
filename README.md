...
#####  A fully interactive E-commerce dashboard built in Tableau Public, utilizing multiple calculated fields to enable dynamic analysis and deeper business insights.
